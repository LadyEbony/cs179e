...
public class VaporInitializer extends GJDepthFirst<VaporReturnStruct, String>{
   ...
   public VaporReturnStruct visit(PrintStatement n, String para) {
      n.f0.accept(this, null);
      n.f1.accept(this, null);
      VaporReturnStruct test = n.f2.accept(this, null); //what does this call
      //addContentLine("cringe tbh");
      String varid = "t." + var++;

     
      n.f3.accept(this, null);
      n.f4.accept(this, null);
      if(!test.checkLiteral) {
        addContentLine(varid + " = " + test.identifier);
	  }
      if(!test.checkLiteral) {
       addContentLine("PrintIntS(" + varid + ")");
	  }
      else {
        addContentLine("PrintIntS(" + test.identifier + ")");
	  }
    ...
    */
	...
	public VaporReturnStruct visit(MessageSend n, String para) {
        ...
        /*
        if(exp2.checkLiteral == false) {
            String temp2 = exp2.identifier;
            return new VaporReturnStruct(temp2, null);
		}
        */
